...
To take a look at these analyses, you can click on the dataset folder listed above. There you will see a folder for each portfolio project. Each folder contains the Jupyter Notebook file where the analysis was done, a pdf of all figures from the analysis, a report breaking down the results of the analysis, and the original dataset file. 
